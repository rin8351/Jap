...
a={
    ...
    'した':{
        'words':{'ちょっと':'ちょっと','すこし':'すこし','もう少し':'もうすこし', },
        'trans':{'ちょっと':'немного','すこし':'немного','もう少し':'ещё немного', },
    ...
    '方':{
        'words':{'読み':'よみ', '話':'はなし', '書き':'かき'},
        'trans':{'読み':'чтение', '話':'разговор', '書き':'писать'},
        'answer':{'読み方':'способ чтения', '話方':'способ разговора', '書き方':'способ писать'},
        'reading':{'読み方':'よみかた', '話方':'はなしかた', '書き方':'かきかた'},
    },
}
